...
const navigation = {
  ...
  initSpaNavigation(closeSidebar) {
    ...
    const tripTemplate = `
      ...
      <div class="trip-page-content" id="modal-page-slider">
        <div class="trip-page-main modal-page--main" id="modal-page-main">
          <div class="trip-hero is-loading" id="trip-hero">
            <div class="trip-hero-overlay"></div>
            <div class="trip-hero-content">
              <h1 id="trip-title" class="trip-hero-title"></h1>
            ...
            <div class="container">
              <div id="trip-content">
                <div class="skeleton-days">
                  <div class="skeleton-day"><div class="skeleton-day-sidebar"><div class="skeleton-day-number"></div><div class="skeleton-day-meta"></div></div><div class="skeleton-day-list"><div class="skeleton-item"><div class="skeleton-item-icon"></div><div class="skeleton-item-time"></div><div class="skeleton-item-text"></div></div><div class="skeleton-item"><div class="skeleton-item-icon"></div><div class="skeleton-item-time"></div><div class="skeleton-item-text skeleton-item-text--short"></div></div><div class="skeleton-item"><div class="skeleton-item-icon"></div><div class="skeleton-item-text skeleton-item-text--med"></div></div></div></div>
                  <div class="skeleton-day"><div class="skeleton-day-sidebar"><div class="skeleton-day-number"></div><div class="skeleton-day-meta"></div></div><div class="skeleton-day-list"><div class="skeleton-item"><div class="skeleton-item-icon"></div><div class="skeleton-item-time"></div><div class="skeleton-item-text skeleton-item-text--med"></div></div><div class="skeleton-item"><div class="skeleton-item-icon"></div><div class="skeleton-item-text"></div></div></div></div>
                  <div class="skeleton-day"><div class="skeleton-day-sidebar"><div class="skeleton-day-number"></div><div class="skeleton-day-meta"></div></div><div class="skeleton-day-list"><div class="skeleton-item"><div class="skeleton-item-icon"></div><div class="skeleton-item-time"></div><div class="skeleton-item-text skeleton-item-text--short"></div></div></div></div>
                </div>
              </div>
            </div>
          </main>
    ...
    const navigateToTrip = async (url, pushState) => {
      ...
      document.querySelector('meta[name="theme-color"]')?.setAttribute('content', '#f7fafd');
