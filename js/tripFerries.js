          ...
          ${(ferry.pdfPath || ferry.documentUrl) ? `
            <div class="ferry-doc-existing" data-existing-doc>
              <div style="display:flex;align-items:center;gap:10px;padding:10px 12px;border:1px solid var(--color-gray-200);border-radius:8px;background:var(--color-gray-50,#f9fafb)">
                ...
                <button type="button" class="btn-download-pdf ferry-doc-action-btn" data-pdf-path="${escAttr(ferry.pdfPath || ferry.documentUrl)}" title="Apri" style="display:flex;align-items:center;color:var(--color-primary);flex-shrink:0;padding:4px;border-radius:4px;transition:background .15s;background:none;border:none;cursor:pointer">
