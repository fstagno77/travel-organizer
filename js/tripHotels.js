...
(function() {
  ...
  function renderHotels(container, hotels) {
    if (!hotels || hotels.length === 0) {
      container.innerHTML = `
        <div class="empty-state">
          ...
          <button class="btn btn-primary empty-state-cta" id="empty-add-hotel">
      ...
      const addBtn = container.querySelector('#empty-add-hotel');
      if (addBtn) {
    ...
    const sectionHeader = `
      <div class="section-header">
        ...
        <div class="section-header-actions">
          <button class="section-header-cta btn btn-hotel" id="hotels-add-booking-btn">
            ${plusSvg}
            <span class="section-header-cta-label-full">Aggiungi</span>
            <span class="section-header-cta-label-short">Aggiungi</span>
          </button>
          <button class="section-header-cta btn btn-hotel-outline" id="hotels-manage-booking-btn">
            ${editSvg}
    ...
    const manageBtn = document.getElementById('hotels-manage-booking-btn');
    if (manageBtn) {
